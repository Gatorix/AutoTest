...
class TestStandardMenu(LoginPage,
    ...
    #         level_one_menu = list(ACCOUNTING_MENU.keys())
    #         for _ in ['政府录凭证', '非盈利报表', '政府报表', '村集体报表']:
    #             level_one_menu.remove(_)
    #         for _level_one_menu in level_one_menu:
    #             if not ACCOUNTING_MENU.get(_level_one_menu):
    #                 self.click_accounting_data_menu(_level_one_menu)
    #                 assert self.is_top_tab_visible(_level_one_menu)
    #                 self.close_tab_by_tab_name(_level_one_menu)
    #             else:
    #                 for _level_two_menu in ACCOUNTING_MENU.get(_level_one_menu):
    #                     if _level_two_menu == '现金流量初始金额':
    #                         continue
    #                     self.click_accounting_data_menu(_level_one_menu,
    #                                                     _level_two_menu if _level_two_menu else None)
    #                     assert self.is_top_tab_visible(_level_two_menu if _level_two_menu else _level_one_menu)
    #                     self.close_tab_by_tab_name(_level_two_menu if _level_two_menu else _level_one_menu)

    #
    # @allure.title('随机菜单')
    # def test_random_choose_menu_for_100_times(self):
    #     with allure.step('登录'):
    #         self.login(company=self.company)
    #     with allure.step('点击菜单'):
    #         level_one_menu = list(ACCOUNTING_MENU.keys())
    ...
    #             level_one_menu.remove(_)
    #         for _ in range(100):
    #             _level_one_menu = random.choice(level_one_menu)
    #             _level_two_menu = random.choice(ACCOUNTING_MENU.get(_level_one_menu)) if ACCOUNTING_MENU.get(
    #                 _level_one_menu) != [] else None
    #             self.click_accounting_data_menu(_level_one_menu, _level_two_menu)
    #             assert self.is_top_tab_visible(_level_two_menu if _level_two_menu else _level_one_menu)
    #             self.close_tab_by_tab_name(_level_two_menu if _level_two_menu else _level_one_menu)
