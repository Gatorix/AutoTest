...
from page.accounting.page_settings import SettingsInvoiceVoucherTemplatePage
from page.accounting.page_voucher import VoucherDetailPage, VoucherPage
...
from page.accounting.page_smart_bookkeeping import (OrganizeInvoicePage,
                                                    OutputInvoicePage,
                                                    BankBillPage,
                                                    IncomeInvoicePage)
from page.accounting.page_common import AccountingCommonPage, VOUCHER_TEMPLATE
...
class TestBankBill(
    ...
    def test_import_unselect_file(self):
        company = GetYamlData().get_company('company_accounting_smart_bookkeeping_028')
        with allure.step('登录'):
            self.login(company=company)
        with allure.step('点击会计菜单'):
    ...
    def test_import_bank_bill_bank_subject_unselect(self):
        ...
        with allure.step('导入'):
            ...
            self.click_import_bank_bill_conform_button()
            assert '请指定银行科目' in self.get_all_floating_tip()
