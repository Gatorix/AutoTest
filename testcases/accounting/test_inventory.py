...
from page.accounting.page_voucher import VoucherDetailPage
...
from page.accounting.page_inventory import (InventorySettingPage,
                                            InventoryManagePage,
...
class TestInventoryWarehousingEntry(
    ...
    def test_new_turnover_material_warehousing_entry_verify_unit_price(self):
        ...
        with allure.step('新增产品入库单'):
            ...
            assert '3.49' == self.get_table_cells_value('单价')
...
class TestInventoryExport(
    ...
    def test_inventory_export_init_inventory(self):
        ...
        with allure.step('导出模板'):
            ...
            self.rename_downloaded_file(tmp_filename)
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(f'{get_project_path()}/template/accounting/inventory/库存初始数量-001.xls',
                                    f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
    ...
    def test_inventory_summary_default(self):
        ...
        with allure.step('导出并比对excel文件'):
            ...
            self.rename_downloaded_file(tmp_filename)
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(f'{get_project_path()}/template/accounting/inventory/存货汇总表-默认.xls',
                                    f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
    ...
    def test_inventory_summary_by_month(self):
        ...
        with allure.step('导出并比对excel文件'):
            ...
            self.rename_downloaded_file(tmp_filename)
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(f'{get_project_path()}/template/accounting/inventory/存货汇总表-按月汇总.xls',
                                    f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
    ...
    def test_inventory_summary_display_all(self):
        ...
        with allure.step('导出并比对excel文件'):
            ...
            self.rename_downloaded_file(tmp_filename)
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(f'{get_project_path()}/template/accounting/inventory/存货汇总表-显示全部.xls',
                                    f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
    ...
    def test_inventory_summary_display_amount(self):
        ...
        with allure.step('导出并比对excel文件'):
            ...
            self.rename_downloaded_file(tmp_filename)
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(f'{get_project_path()}/template/accounting/inventory/存货汇总表-显示金额.xls',
                                    f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
    ...
    def test_inventory_summary_check_all(self):
        ...
        with allure.step('导出并比对excel文件'):
            ...
            self.rename_downloaded_file(tmp_filename)
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(f'{get_project_path()}/template/accounting/inventory/存货汇总表-勾选全部.xls',
                                    f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
    ...
    def test_inventory_detail_export_present(self):
        ...
        with allure.step('导出并比对excel文件'):
            ...
            self.rename_downloaded_file(tmp_filename)
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(f'{get_project_path()}/template/accounting/inventory/存货收发明细表-铜覆铝.xls',
                                    f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
    ...
    def test_inventory_detail_export_present_display_amount(self):
        ...
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(
                f'{get_project_path()}/template/accounting/inventory/存货收发明细表-铜覆铝-显示金额.xls',
                f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
    ...
    def test_inventory_detail_export_all(self):
        ...
        with allure.step('导出并比对excel文件'):
            ...
            self.rename_downloaded_file(tmp_filename)
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(f'{get_project_path()}/template/accounting/inventory/存货收发明细表-全部.xls',
                                    f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
    ...
    def test_inventory_detail_export_all_display_amount(self):
        ...
        with allure.step('对比excel文件差异'):
            assert check_excel_diff(
                f'{get_project_path()}/template/accounting/inventory/存货收发明细表-全部-显示金额.xls',
                f'{get_project_path()}\\download_tmp\\{self.test_id}\\{tmp_filename}')
