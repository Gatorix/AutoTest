...
from page.web_ui.manager.page_contract import ContractPage
...
from page.web_ui.manager.page_collection import CollectionPage
...
class TestCollection(
    ...
    def test_query_contract_amount_should_remove_already_del_contract_amount(self):
        ...
        with allure.step('检查下次收款日期'):
            assert '2024.01-2024.12' in self.get_text_from_collection_list_next_period_item_by_company(
                f'{company_name}_恢复')
