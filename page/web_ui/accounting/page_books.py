...
class SubsidiaryLedgerPage(SubsidiaryLedgerBase, BaseTestCase):
    ...
    def select_year(self, year):
        self.click(self.year_selector())
        self.click(self.year_items(year))

    def select_period(self, from_or_to, year, item):
...
class BalancePage(BalanceBase, BaseTestCase):
    ...
    def wait_for_balance_loading_finish(self):
        self.wait_for_element_not_visible(self.balance_loading())

    def click_balance_page_buttons(self, button):
        self.click(self.balance_page_buttons(button))

    def get_text_from_balance_total_line(self):
        return self.get_text(self.balance_total_line())

    def get_text_from_balance_page_total_pages(self):
        return self.get_text(self.balance_page_total_pages())

    def get_text_from_balance_page_current_page(self):
        return self.get_text(self.balance_page_current_page())
...
class QuantityAmountLedgerPage(QuantityAmountLedgerBase, BaseTestCase):
    ...
    def click_filter_inputs_by_label(self, label):
        self.click(self.filter_inputs_by_label(label))
