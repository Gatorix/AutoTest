...
class AccountingCommonPage(BaseTestCase, AccountingCommonBase):
    ...
    def close_tab_by_tab_name(self, tab):
        self.click_accounting_my_company_span()
    ...
    def get_text_from_accounting_focus_table_sys_tips(self):
        return self.get_text(self.accounting_focus_table_sys_tips())
    ...
    def click_accounting_focus_table_radio_items_by_span(self, span):
        self.click(self.accounting_focus_table_radio_items_by_span(span))

    def is_accounting_iframe_error_h1_visible(self):
        return self.is_element_visible(self.accounting_iframe_error_h1())

    def get_accounting_current_period(self):
        return self.get_text(self.accounting_current_period())

    def click_accounting_my_company_span(self):
